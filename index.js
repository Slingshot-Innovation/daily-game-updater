...
async function runDailyUpdate() {
    try {
        ...
        console.log(`Daily update completed. Processed ${totalProcessedGames} games.`);
    } catch (error) {
        console.error('Error in daily update:', error);
    }
}

// Schedule the task to run at 1 minute past midnight UTC
cron.schedule('1 0 * * *', runDailyUpdate, {
    scheduled: true,
    timezone: "UTC"
});

console.log('Daily game update service started');